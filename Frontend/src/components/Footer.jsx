...
function Footer() {
    return (
        <footer className="w-full relative  bg-linear-to-tl from-gray-900 via-gray-800 to-gray-900 text-gray-300 overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-gray-500 to-transparent blur-sm"></div>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    
                    <div className="space-y-4">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-200">GuardianEye</h2>
                        <p className="text-gray-400 text-sm leading-relaxed">
                            AI-powered truth detection to combat misinformation and strengthen intelligence in the digital age.
                        </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><a href="#api" className="text-gray-400 hover:text-white transition-colors text-sm">API</a></li>
                        </ul>
                    </div>
